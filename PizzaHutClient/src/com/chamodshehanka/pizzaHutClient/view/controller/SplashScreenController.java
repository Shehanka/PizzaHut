...
import com.chamodshehanka.pizzaHutClient.main.StartProject;
...
/**
 * @author chamodshehanka on 11/27/2017
 * @project PizzaHut
 **/
        ...
        fadeOut.setOnFinished((e)->{
            try {
                AnchorPane parentPane = FXMLLoader.load(getClass().getResource(
                        "/com/chamodshehanka/pizzaHutClient/view/fxml/MainMenuUI.fxml"
                ));
